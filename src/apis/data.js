export default {
    recipes: [
        ...
        },
        {
            ...
            rate: 3.5,
            accepted: true,
            published_at: new Date('2020-12-06'),
            tags: [2, 6],
            category_id: 3,
            userId : 4,
            status : 'accepted',
        ...
        },
        {
            ...
            rate: 2.5,
            accepted: true,
            published_at: new Date('2020-12-07'),
            tags: [2, 6],
            category_id: 6,
            userId : 2,
            status : 'accepted',
        ...
        },
        {
            ...
            rate: 3.5,
            accepted: true,
            published_at: new Date('2020-12-03'),
            tags: [2, 4],
            category_id: 7,
            userId : 5,
            status : 'accepted',
    ...
    reviews: [
        ...
        },
        {
            ...
            body:
                "I don't want to be?' it asked. 'Oh, I'm not Ada,' she said, 'and see whether it's marked \"poison\" or not'; for she had asked it aloud; and in despair she put her hand on the end of the.",
            created_at: new Date('2020-12-05'),
            rating : 3,
        },
        {
            id: 13,
            ...
            body:
                "I don't want to be?' it asked. 'Oh, I'm not Ada,' she said, 'and see whether it's marked \"poison\" or not'; for she had asked it aloud; and in despair she put her hand on the end of the.",
            created_at: new Date('2020-12-02'),
            rating : 1,
        },
        {
            id: 14,
            ...
            body:
                "I don't want to be?' it asked. 'Oh, I'm not Ada,' she said, 'and see whether it's marked \"poison\" or not'; for she had asked it aloud; and in despair she put her hand on the end of the.",
            created_at: new Date('2020-12-07'),
            rating : 5,
        },
        {
            id: 15,
            ...
            body:
                "I don't want to be?' it asked. 'Oh, I'm not Ada,' she said, 'and see whether it's marked \"poison\" or not'; for she had asked it aloud; and in despair she put her hand on the end of the.",
            created_at: new Date('2020-12-03'),
            rating : 2,
        },
    ],
    tags: [
    ...
    users: [
        ...
        },
        {
            ...
            role: 'user',
            password: '3151516566546',
            confirm_password: '3151516566546',
            first_seen : new Date('2018-08-05'),
            last_seen : new Date('2020-03-16'),
            planned : true,
            created_at: new Date('2018-08-05'),
        },
        {
            id: 3,
            username: 'Annamarie Mayer',
            email: 'mayer@gmail.com',
            role: 'user',
            password : '3151646464646',
            confirm_password: '3151646464646',
            first_seen : new Date('2018-06-25'),
            last_seen : new Date('2020-07-13'),
            planned : false,
            created_at : new Date('2018-06-25'),
        },
        {
            id: 4,
            ...
            role: 'user',
            password: '3651651651656',
            confirm_password: '3651651651656',
            first_seen : new Date('2020-08-15'),
            last_seen : new Date('2020-11-06'),
            planned : true,
            created_at : new Date('2020-08-15'),
        },
        {
            id: 5,
            username: 'Kralie Sture',
            email: 'sture@gmail.com',
            role: 'user',
            password : '36464646464646',
            confirm_password : '36464646464646',
            first_seen : new Date('2018-02-01'),
            last_seen : new Date('2020-07-17'),
            planned : true,
            created_at : new Date('2018-02-01'),
        },
        {
            id: 6,
            username: 'Garen Aray',
            email: 'aray@gmail.com',
            role: 'user',
            password : '3697818846464646',
            confirm_password : '3697818846464646',
            first_seen : new Date('2019-12-15'),
            last_seen : new Date('2020-11-23'),
            planned : true,
            created_at : new Date('2019-12-15'),
        },
        {
            id: 7,
            username: 'Barry Alien',
            email: 'alien@gmail.com',
            role: 'user',
            password : '15151616516161',
            confirm_password : '15151616516161',
            first_seen : new Date('2020-11-29'),
            last_seen : new Date('2020-12-04'),
            planned : true,
        ...
        },
        {
            ...
            role: 'user',
            password : '561511616515156',
            confirm_password : '561511616515156',
            first_seen : new Date('2020-11-22'),
            last_seen : new Date('2020-12-06'),
            planned : true,
            created_at : new Date('2020-11-22'),
        },
        {
            id: 9,
            username: 'Clark Kent',
            ...
            role: 'user',
            password : '455465466644',
            confirm_password : '455465466644',
            first_seen : new Date('2020-11-15'),
            last_seen : new Date('2020-12-05'),
            planned : true,
            created_at : new Date('2020-11-15'),
        },
    ],
    planners : [
        {
    ...
    categories : [
        { 
            id: 0, 
            name: 'vietnam',
            image: 'https://i.imgur.com/00KfTSo.jpg'
        },
        { 
            id: 1, 
            name: 'japan',
            image: 'https://i.imgur.com/Xya1cQo.jpg'
        },
        { 
            id: 2, 
            name: 'italy',
            image: 'https://i.imgur.com/swRJJmQ.jpg'
        },
        { 
            id: 3, 
            name: 'pork',
            image: 'https://i.imgur.com/DfTyq0m.jpg'
        },
        { 
            id: 4, 
            name: 'fish',
            image: 'https://i.imgur.com/g85fpZ0.jpg'
        },
        { 
            id: 5, 
            name: 'beef',
            image: 'https://i.imgur.com/b2t6H5p.jpg'
        },
        { 
            id: 6, 
            name: 'soup',
            image: 'https://i.imgur.com/W2ee0Vu.jpg'
        },
        { 
            id: 7, 
            name: 'fry',
            image: 'https://i.imgur.com/xcGtaAA.jpg'
        },
        { 
            id: 8, 
            name: 'breakfast',
            image: 'https://i.imgur.com/ZJsl6p8.jpg' 
        },
        { 
            id: 9, 
            name: 'dinner',
            image: 'https://i.imgur.com/aXPjT0W.jpg'
        },
        { 
            id: 10, 
            name: 'chinese',
            image: 'https://i.imgur.com/51qJ1n9.jpg'
        },
        { 
            id: 11, 
            name: 'chicken',
            image: 'https://i.imgur.com/MGwAQxk.jpg'
        },
    ]
};