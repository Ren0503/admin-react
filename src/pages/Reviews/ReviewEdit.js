        ...
        <div className={classes.root}>
            <div className={classes.title}>
                <Typography variant="h6">
                    {translate('resources.reviews.body')}
                </Typography>
            ...
            >
                <RecipeReferenceField formClassName={classes.inlineField} />
                <UserReferenceField formClassName={classes.inlineField} />
                <DateField source="created_at" formClassName={classes.inlineField} />
                <StarRatingField formClassName={classes.inlineField} />
                <TextInput source="body" rowsMax={15} multiline fullWidth />
            </SimpleForm>
        </div>
    );
};
